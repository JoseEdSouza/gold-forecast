...
ARTIFACTS_DIR = REPO_ROOT / "outputs" / "05_lstm"
MODELS_DIR = REPO_ROOT / "outputs" / "05_lstm"
...
tbl.assign(model="lstm").to_csv(METRICS_DIR / "metrics_lstm.csv", index=False)
print(tbl.round(3))
...
model.save(MODELS_DIR / "gold_price_lstm.keras")

print(f"\nArtefatos salvos em: {ARTIFACTS_DIR}")
print(f"Modelo salvo em: {MODELS_DIR / 'gold_price_lstm.keras'}")
