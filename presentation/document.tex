...
\logo{\hspace*{-1.6cm}\includegraphics[scale=0.075]{libs/emblemufc.pdf}\hspace{9.7cm} \vspace{-0.2cm}}
\begin{frame}{}
    \maketitle
\end{frame}
}
...
%% ---------------------------------------------------------------------------
\begin{frame}{2.5.1 Inflação (CPI)}
    \begin{itemize}
...
%% ---------------------------------------------------------------------------
\begin{frame}{2.5.3 Embeddings das manchetes}
    \begin{itemize}
...
\begin{frame}{4.1 Protocolo de avaliação}
    \begin{itemize}
...
\begin{frame}{Os modelos: do mais simples ao mais complexo}
    \begin{figure}
        \centering
        \makebox[\linewidth][c]{\includegraphics[width=1.14\linewidth]{figs/all_models_overview.png}}
...
\begin{frame}{CNN 1D causal: modelo champion}
    \begin{itemize}
        ...
        \item Tamanho aproximado: \textbf{60 mil parâmetros treináveis}.
    \end{itemize}
...
\begin{frame}{Boxplots no walk-forward}
    \begin{figure}
        \centering
        \makebox[\linewidth][c]{\includegraphics[width=1.1\linewidth]{figs/cnn_cv_boxplot.png}}
