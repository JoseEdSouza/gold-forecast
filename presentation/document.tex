...
\begin{frame}{Os modelos: do mais simples ao mais complexo}
    \begin{figure}
        \centering
        \includegraphics[width=0.95\linewidth]{figs/all_models_overview.png}
...
\begin{frame}{Boxplots no walk-forward}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{figs/cnn_cv_boxplot.png}
